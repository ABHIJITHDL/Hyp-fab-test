...
echo "$(json_ccp $ORG $P0PORT $P1PORT $CAPORT $PEERPEM $CAPEM)" > EHR/src/main/resources/static/connection-profiles/org1/connection-org1.json
...
echo "$(json_ccp $ORG $P0PORT $P1PORT $CAPORT $PEERPEM $CAPEM)" > EHR/src/main/resources/static/connection-profiles/org2/connection-org2.json
